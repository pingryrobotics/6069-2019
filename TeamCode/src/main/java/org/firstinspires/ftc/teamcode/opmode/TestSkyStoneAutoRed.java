...
import org.firstinspires.ftc.teamcode.subsystems.StoneGrabber;
...
public class TestSkyStoneAutoRed extends LinearOpMode {
    ...
    private static float offsetY = -2.6f/8f;//changing this moves the three rects and circles up or down, range: (-4, 4) not inclusive
    ...
    public void runOpMode(){
        ...
        StoneGrabber grabber = new StoneGrabber(hardwareMap,gamepad1);
        grabber.initialize();
        drive.initialize();
